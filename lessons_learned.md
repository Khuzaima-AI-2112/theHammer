...
*Changed:* the retry figures above were never true. `withRetry` makes three attempts in all, waiting 1s then 2s, so a 401 cost two more attempts over three seconds. Its delay list carried an unreachable 4s entry, removed in #140.
